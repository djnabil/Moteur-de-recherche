...
function get_title($fichier_html)
{
   ...
   if  (preg_match($modele, $chaine_html, $tableau_resultat)) 
    {
	...
	else return "Le salon des créateurs et des saveurs est de retou";
...
function get_meta_description($nomdefichierHTML)
{
    ...
    return "Les chaînes américaines ont filmé le passage des tornades: colonnes noires balayant le sol, illuminées par des éclairs intermittents";
}
